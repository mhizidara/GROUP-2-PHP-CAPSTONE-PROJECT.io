...
$result = $cnvFromErr = "";
    ...
    if (isset($_POST['convertFrom']) && isset($_POST['convertTo'])) {
        ...
        if($convertFrom == 'Seconds' AND $convertTo == 'Minutes'){
...
<div class="container">
    ...
    <h1 class="display-6" style="text-align: center; margin-top: 20px; margin-bottom: 20px;"><strong>Time Conversions</strong></h1>
