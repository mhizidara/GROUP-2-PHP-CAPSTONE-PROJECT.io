...
$result = $cnvFromErr = "";
    ...
    if (isset($_POST['convertFrom']) && isset($_POST['convertTo'])) {
        ...
        if($convertFrom == 'Meter per second' AND $convertTo == 'Kilometer per hour'){
...
<div class="container">
    ...
    <h1 class="display-6" style="text-align: center; margin-top: 20px; margin-bottom: 20px;"><strong>Speed Conversions</strong></h1>
